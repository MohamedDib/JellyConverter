        ...
        MediaInfo.prototype.analyzeData = function (getSize, readChunk, callback) {
            ...
            if (callback === undefined) {
                return new Promise(function (resolve) {
                    return _this.analyzeData(getSize, readChunk, function (result) { return resolve(result); });
                });
            }
            var runReadDataLoop = function (fileSize) {
                var getChunk = function () {
                    ...
                    var dataValue = readChunk(Math.min(_this.options.chunkSize, fileSize - offset), offset);
